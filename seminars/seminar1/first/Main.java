...
//        assert (long)a + (long) b < Integer.MAX_VALUE : "Ошибка, значение вышло за пределы int";
//        return a + b;
//    }
    ...
    public static void checkingHero() {
        ...
        */
        ...
        assertThat(emmett).isNotNull();
        assertThat(emmett.getName()).isNotEmpty().isEqualTo("Emmett").hasSize(6);
